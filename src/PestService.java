...
public class PestService {
    ...
    public void displayRecommendation(String pestName, String recommendation) {
        System.out.println("========================================");
        System.out.println("       PEST RECOMMENDATION              ");
        System.out.println("========================================");
        System.out.println("  Pest Identified : " + pestName);
